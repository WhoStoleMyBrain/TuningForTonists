...
class WaveDataDisplay extends StatelessWidget {
  const WaveDataDisplay({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const Center(
          child: Text('Wave Data Display', style: TextStyle(fontSize: 24)),
        ),
        Padding(
                ...
                return GetBuilder<WaveDataController>(
                  builder: (waveDataController) => LineChart(
                    LineChartData(
                      ...
                      minX: 0,
                      maxX: waveDataController.waveData.length.toDouble(),
