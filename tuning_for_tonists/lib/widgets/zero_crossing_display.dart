...
class ZeroCrossingDisplay extends StatelessWidget {
  const ZeroCrossingDisplay({super.key});
                  ...
                  builder: (waveDataController) => LineChart(
                    LineChartData(
                      ...
                      minY: waveDataController.zeroCrossingData
                          .reduce(min)
                          .toDouble(),
                      maxY: waveDataController.zeroCrossingData
                          .reduce(max)
                          .toDouble(),
                      minX: 0,
                      maxX:
